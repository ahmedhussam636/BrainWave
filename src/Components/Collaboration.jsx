...
import CollaborationWithDetails from "./CollaborationWithDetails";
    ...
    <Section crosses>
      ...
      >
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">App for seamless collaboration</h2>
      ...
      {showDetails && <CollaborationWithDetails onClose={() => setShowDetails(false)} />}
    </Section>
  );
};
